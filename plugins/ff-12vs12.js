...
(𝚁𝚎𝚊𝚌𝚌𝚒𝚘𝚗𝚊 𝚌𝚘𝚗 👍🏻 𝚙𝚊𝚛𝚊 𝚞𝚗𝚒𝚛𝚝𝚎 𝚎𝚜𝚌𝚞𝚊𝚍𝚛𝚊 1, ❤️ 𝚙𝚊𝚛𝚊 𝚞𝚗𝚒𝚛𝚝𝚎 𝚎𝚜𝚌𝚞𝚊𝚍𝚊 2, 😂 𝚙𝚊𝚛𝚊 𝚞𝚗𝚒𝚛𝚝𝚎 𝚎𝚜𝚌𝚞𝚊𝚍𝚊 3, 😢 𝚙𝚊𝚛𝚊 𝚞𝚗𝚒𝚛𝚝𝚎 𝚜𝚞𝚙𝚕𝚎𝚗𝚝𝚎𝚜)
  `.trim()
  ...
  conn.ev.on('messages.upsert', async ({ messages }) => {
    ...
    if (data.escuadra1.includes(sender) || data.escuadra2.includes(sender) || data.escuadra3.includes(sender) || data.suplentes.includes(sender)) return
...
🥷🏻 ┇ ${suplentes[1] || ''}
  ...
  `.trim()
    ...
    await conn.sendMessage(data.chat, {
      ...
      mentions: [...data.escuadra1, ...data.escuadra2, ...data.escuadra3, ...data.suplentes]
    })
  })
}
