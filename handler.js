...
global.dfail = (type, m, conn) => {
    const msg = {
        rowner: `🚩 Hola, este comando solo puede ser utilizado por *SAPITOBOT*.`,
        owner: `👤 Usuario, Este Comando Solo Puede Ser Utilizado Por *SAPITOBOT*.`,
        mods: `🤚🏻 Hola, este comando solo puede ser utilizado por *SAPITOBOT*.`,
