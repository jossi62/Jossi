...
const msg = {
rowner: `🚩 Hola, este comando solo puede ser utilizado por *@Ferr*.`,
owner: `👤 Usuario, Este Comando Solo Puede Ser Utilizado Por *@Ferr*.`,
mods: `🤚🏻 Hola, este comando solo puede ser utilizado por *@Ferr*.`,
